...
\clearpage
	...
	\begin{figure}
		\begin{centering}
			\includegraphics[width=1.0\textwidth]{ml-unicode.jpg}
	...
	\paragraph{}
	മലയാളത്തിലെ ചില അക്ഷരങ്ങള്‍ക്ക് സാര്‍വ്വത്രികമായി ഒരേ രൂപമല്ല ഉള്ളത്. 'ച്ച', 'കൂ', 'ള്ള' തുടങ്ങിയവയുടെ ശൈലീഭേദങ്ങളുള്‍ക്കൊണ്ടുകൊണ്ട് അവ കൂടി ഗായത്രിയിൽ ചേര്‍ത്തിട്ടുണ്ട്. സോഫ്റ്റ്‌വെയര്‍ സഹായത്തോടെ ഇതിലേതുവേണമെന്നു തെരഞ്ഞെടുക്കാന്‍ ഉപയോക്താവിനാകും.
	...
	\begin{figure}
		\begin{centering}
			\includegraphics[width=1.0\textwidth]{variants.jpg}
	...
	\begin{figure}
		\begin{centering}
			\includegraphics[width=1.0\textwidth]{ka.jpg}
	...
	\begin{figure}
		\begin{centering}
			\includegraphics[width=1.0\textwidth]{latin.jpg}
	...
	\begin{figure}
		\begin{centering}
			\includegraphics[width=1.0\textwidth]{article-layout.jpg}
	...
	\begin{figure}
		\begin{centering}
			\includegraphics[width=1.0\textwidth]{zha.jpg}
	...
	\begin{figure}
		\begin{centering}
			\includegraphics[width=1.0\textwidth]{numerals.jpg}
...
\end{tabular}
	...
	\include{Gayathri-Regular-Report}
